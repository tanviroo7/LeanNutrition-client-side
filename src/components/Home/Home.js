  ...
  return (
    <div>
      ...
      <div className="banner-container md:grid md:grid-cols-2">
        <div className="mt-48 ml-26">
          <p className=" ">FINDING BALANCE IN FOOD, HEALTH AND WELLNESS</p>
          <p className="text-6xl text-gray-500 mt-4 font-extrabold">
            Eat Mindfully, Sweat Often & Self Love Always
          </p>
          <Link to="/services">
            <button className="p-2 bg-green-600 text-white hover:bg-green-700 mt-6 rounded-lg font-bold">
              Learn more
            </button>
          </Link>
        </div>
          ...
          <div className="mt-8 overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
                <h1 className="text-4xl sm:text-5xl text-green-800 dark:text-white font-extrabold tracking-tight">
                  Get in touch
                </h1>
                ...
                <div className="flex items-center mt-8 text-gray-600 dark:text-gray-400">
                  ...
                  <div className="ml-4 text-md tracking-wide font-semibold w-40">
                    LeanNutrition, Angel view, South BenWell, NE47UR
                  </div>
                </div>
              ...
              <form className="p-6 flex flex-col justify-center">
                ...
                <button
                  type="submit"
                  className="md:w-32 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-green-700 transition ease-in-out duration-300"
                >
                  Submit
                </button>
              </form>
