    ...
    <div>
      <div className="flex flex-col items-center justify-center py-24 lg:py-12 md:px-16 px-4">
        ...
        <div className="flex md:flex-row flex-col items-center justify-center md:gap-8 mt-4 mb-12 w-full">
          <Link to="/home">
            <button className="p-4 text-base text-center text-white md:w-auto md:mb-0  w-full bg-indigo-700 border rounded-md hover:bg-indigo-800">
              Get back to Homepage
            </button>
          </Link>

          <button className="p-4 text-base font-semibold text-center md:w-auto  bg-gray-100 text-indigo-700 border rounded-md hover:bg-gray-200">
            Contact Support
          </button>
        </div>
